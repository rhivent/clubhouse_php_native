...
$result = mysqli_query($koneksi, "SELECT * FROM tbl_member_warga ORDER BY id_warga ASC");
?>
        ...
        <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?= $user_data['no_kavling']; ?></td>
                    <td><?= $user_data['nama_warga']; ?></td>
                    ...
                    <td class="text-center"><a href='warga/edit.php?id=<?= $user_data["id_warga"]; ?>'>Edit</a> | <a onclick="return confirm('Anda yakin HAPUS member ?')" href='warga/delete.php?id=<?= $user_data["id_warga"]; ?>'>Delete</a></td>
                </tr>
                <?php $no++;}?>
