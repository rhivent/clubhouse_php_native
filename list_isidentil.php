<?php
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM tbl_member_isidentil ORDER BY id_isidentil ASC");
        ...
        <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href='export_isidentil.php?id=<?= $user_data["id_isidentil"]; ?>' title="Download PDF"><?= $user_data['nama_umum']; ?></a></td>
                    <td class="text-center"><span class="badge badge-primary"><?= $user_data['status']; ?></span></td>
                    <td class="text-center"><?= $user_data['jenis_member']; ?></td>
                    <td class="text-center"><?= $user_data['jenis_paket']; ?></td>
